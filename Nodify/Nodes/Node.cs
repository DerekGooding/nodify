...
public class Node : HeaderedContentControl
{
    ...
    /// <summary>
    /// Gets or sets the brush used for the background of the <see cref="Footer"/> of this <see cref="Node"/>.
    /// </summary>
    ...
    static Node() => DefaultStyleKeyProperty.OverrideMetadata(typeof(Node), new FrameworkPropertyMetadata(typeof(Node)));
}
