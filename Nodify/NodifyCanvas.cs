...
public class NodifyCanvas : Panel
{
    public static readonly DependencyProperty ExtentProperty = 
        DependencyProperty.Register(nameof(Extent), typeof(Rect), 
            typeof(NodifyCanvas), new FrameworkPropertyMetadata(BoxValue.Rect));
    ...
    protected override Size ArrangeOverride(Size arrangeSize)
    {
        ...
        {
            var item = (INodifyCanvasItem)element;
