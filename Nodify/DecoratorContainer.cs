...
public class DecoratorContainer : ContentControl, INodifyCanvasItem
{
    ...
    static DecoratorContainer() 
        => DefaultStyleKeyProperty.OverrideMetadata(typeof(DecoratorContainer),
            new FrameworkPropertyMetadata(typeof(DecoratorContainer)));

    /// <inheritdoc />
    protected override void OnRenderSizeChanged(SizeChangedInfo sizeInfo) => ActualSize = sizeInfo.NewSize;
}
