...
[TemplatePart(Name = _elementScrollViewer, Type = typeof(ScrollViewer))]
public class TabControlEx : TabControl
{
    private const string _elementScrollViewer = "PART_ScrollViewer";
    ...
    public override void OnApplyTemplate()
    {
        ...
        ScrollViewer = GetTemplateChild(_elementScrollViewer) as ScrollViewer;
