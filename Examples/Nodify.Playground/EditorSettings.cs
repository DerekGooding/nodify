    ...
    private EditorSettings()
    {
        ...
        AdvancedSettings = new ObservableCollection<ISettingViewModel>()
        {
            new ProxySettingViewModel<double>(
                ...
                val => HandleRightClickAfterPanningThreshold = val,
                "Disable context menu after panning: ",
                "Disable after mouse moved this far"),
            new ProxySettingViewModel<double>(
                () => AutoPanningTickRate,
                val => AutoPanningTickRate = val,
            ...
            new ProxySettingViewModel<uint>(
                ...
                val => OptimizeMinimumSelectedItems = val,
            ...
            new ProxySettingViewModel<bool>(
                ...
                val => EnableRenderingOptimizations = val,
            ...
            new ProxySettingViewModel<double>(
                ...
                val => OptimizeRenderingZoomOutPercent = val,
            ...
            new ProxySettingViewModel<uint>(
                () => OptimizeRenderingMinimumNodes,
                val => OptimizeRenderingMinimumNodes = val,
                "Rendering optimization minimum nodes: ",
                "The minimum nodes needed to start optimizing when zoom out percent is met."),
            new ProxySettingViewModel<bool>(
                () => EnableDraggingOptimizations,
                val => EnableDraggingOptimizations = val,
            ...
            new ProxySettingViewModel<double>(
                ...
                val => FitToScreenExtentMargin = val,
                "Fit to screen extent margin: ",
                "Adds some margin to the nodes extent when fit to screen"),
            new ProxySettingViewModel<bool>(
                () => EnableStickyConnectors,
                val => EnableStickyConnectors = val,
