...
public class CalculatorViewModel : ObservableObject
{
    public CalculatorViewModel()
    {
        ...
        .WhenRemoved(c =>
        {
            int ic = Connections.Count(con => con.Input == c.Input || con.Output == c.Input);
            int oc = Connections.Count(con => con.Input == c.Output || con.Output == c.Output);
    ...
    internal static bool CanCreateConnection(ConnectorViewModel source, ConnectorViewModel? target)
